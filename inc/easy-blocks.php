...
if ( is_plugin_active( 'elementor/elementor.php' ) ) {    
    jewel_ht_fb_like_admin_notice_requires();
}


function jewel_ht_fb_like_admin_notice_requires(){
	
	include( plugin_dir_path( __FILE__ ) . 'class-tgm-plugin-activation.php');

	add_action( 'tgmpa_register', 'jewel_ht_fb_like_register_required_plugins' );
}



function jewel_ht_fb_like_register_required_plugins(){
    $plugins = array(   
        array(
