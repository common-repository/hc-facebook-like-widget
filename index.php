...
Description: Facebook like widget plugin for WordPress
Plugin URI: https://jeweltheme.com/product/facebook-like-widget-plugin
Author: Liton Arefin
Version: 1.0.4
...
include( plugin_dir_path( __FILE__ ) . 'inc/easy-blocks.php');